...
function GameScene.load()
  ...
  local Tree3 = require("src.entities.Decoration.Tree3")
  ...
  local Tent1 = require("src.entities.Decoration.Tent1")
  local Tent2 = require("src.entities.Decoration.Tent2")
  local Firepit = require("src.entities.Decoration.Firepit")
  ...
  TreeStump.create(240, 420, ecsWorld, physicsWorld)
  ...
  Tent1.create(450, 360, ecsWorld, physicsWorld)
  Tent2.create(350, 360, ecsWorld, physicsWorld)
  Firepit.create(380, 440, ecsWorld, physicsWorld)
