...
---@field BASE_RENDER_WIDTH number
---@field BASE_RENDER_HEIGHT number
...
-- Base render resolution (before scaling)
GameConstants.BASE_RENDER_WIDTH = 160
GameConstants.BASE_RENDER_HEIGHT = 90
