...
---Create a new Tree3 entity (static object)
...
function Tree3.create(x, y, world, physicsWorld)

    local tree = Entity.new()
    local position = Position.new(x, y, 0)
    local spriteRenderer = SpriteRenderer.new('tree3', 86, 144)
    local pathfindingCollision = PathfindingCollision.new(24, 20, "static", 32, 120, "circle")
